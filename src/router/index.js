      ...
      children: [
        {
          ...
          meta: {
            fr: {
              ...
              keywords: 'portfolio, accueil, catif, bradley, barbier, bradley barbier',
            },
            en: {
              title: 'Catif - Home',
              description: 'Home page of my portfolio',
              keywords: 'portfolio, home, catif, bradley, barbier, bradley barbier',
            },
          },
        },
        {
        ...
        },
        {
          ...
          meta: {
            fr: {
              title: 'Catif - Blog',
              description: 'Page de mon blog',
              keywords: 'blog, article, catif, bradley, barbier, bradley barbier',
            },
            en: {
              title: 'Catif - Blog',
              description: 'Blog page of my portfolio',
...
router.beforeEach((to, from, next) => {
  ...
  if (['fr', 'en'].includes(lang)) {
    ...
    document.querySelector('meta[name="description"]').setAttribute('content', to.meta[lang].description)
    document.querySelector('meta[name="keywords"]').setAttribute('content', to.meta[lang].keywords)
    next()
  }
  else {
    ...
    document.querySelector('meta[name="description"]').setAttribute('content', to.meta[defaultLang].description)
    document.querySelector('meta[name="keywords"]').setAttribute('content', to.meta[defaultLang].keywords)
    next()
  }
})
